		...
		<form action="<%=request.getContextPath()%>/insert.do" method="post">
			...
			<div class="idContainer">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label class="label" for="name">I D : </label> <input type="text"
					...
					<input type="button" onclick="f_idCheck()" value="중복검사">
			</div>

			<div class="inputContainer">
				<label for="name">PW : </label> <input type="text" id="dicPw"
					name="dicPw" placeholder="비밀번호는 8자 이상이어야 하며, 숫자/대문자/영문을  포함해야 합니다.." required>
			</div>
			<div class="inputContainer">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label for="name">PW 확인 : </label> <input type="text" id="Pwchk"
					name="Pwchk" placeholder="비밀번호 확인을 위해  재입력하세요" required>
					<input type="button" onclick="f_pwCheck()" value=" 확인"> 
			</div>
			...
			<div class="inputContainer">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label for="name">전화번호 : </label> <input type="text" id="dicPh"
					name="dicPh" placeholder="핸드폰 번호를 입력하세요" required>
					<input type="button" onclick="f_phCheck()" value="확인"> 

			</div>
			<div class="inputContainer">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label for="name">이메일 : </label> 
				<input type="text" id="dicMail" name="dicMail" placeholder="이메일을 입력하세요" required>
					<input type="button" onclick="f_codeSend()" value="이메일인증보내기"> 
			</div>
			<div class="inputContainer">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label for="name">인증 확인 : </label> 
				<input type="text" id="ckmail" name="ckmail" placeholder="이메일 인증번호를 입력하세요" required>
					<input type="button" onclick="f_codeCk()" value="이메일인증"> 
			</div>
			<div class="inputContainer">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox"
				name="agree_all" id="agree_all" > 
				<span><strong>모두 동의합니다</strong></span><br>
			</label> 
			<label class="jh_huk" for="agree">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="agree"
				value="1" required> <span>이용약관 동의<strong>(필수)</strong></span><br>
			</label> 
			<label class="jh_huk" for="agree">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="agree"
				value="2" required> <span>개인정보 수집, 이용 동의<strong>(필수)</strong></span>
			</label> 
			<label class="jh_huk" for="agree">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="checkbox" name="agree" value="3" required><span> 개인정보 이용 동의<strong>(필수)</strong></span><br>
			</label>
