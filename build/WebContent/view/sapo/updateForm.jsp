		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="sapoBrnm"
					value="<%=mv.getSapoBrnm()%>" required></td>
			</tr>
			<tr>
				<td>카테고리 :</td>
				<td><input type="text" name="sapoCarte"
					value="<%=mv.getSapoCarte()%>" required></td>
			</tr>
			<tr>
				<td>할인 기간 :</td>
				<td><input type="text" name="sapoUpdae"
					value="<%=mv.getSapoUpdae()%>" required></td>
			</tr>
				<tr>
				<td>링크 : </td>
				<td><input type="text" name="sapoLink" value="<%=mv.getSapoLink() %>" required></td>
			</tr>
