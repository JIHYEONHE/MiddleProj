      ...
      <div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<thead>
					<tr>
						<th style="background-color: #2192b4; text-align: center;">번호</th>
						<th style="background-color: #2192b4; text-align: center;">제목</th>
						<th style="background-color: #2192b4; text-align: center;">작성자</th>
						<th style="background-color: #2192b4; text-align: center;">작성일</th>
						<th style="background-color: #2192b4; text-align: center;">첨부파일</th>
						<th style="background-color: #2192b4; text-align: center;">조회수</th>
<!-- 						<th style="background-color: #eeeeee; text-align: center;">조회수</th> -->
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="${pageContext.request.contextPath}/infoBoard/detail.do?infoboNum=<%= infoBoardList.get(i).getInfoboNum() %>"><%= infoBoardList.get(i).getInfoboTitle() %></a></td>
