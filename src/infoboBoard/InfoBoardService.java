...
public interface InfoBoardService {
	 ...
	 * @param ifv 수정할 회원정보가 들어있는 MemberVO객체
	...
	/**
	 * infobo 테이블에 존재하는 모든 회원정보를 가져와 List에 담아서
	 * 반환하는 메서드
	 * @return InfoBoardVO객체를 담고 있는 List객체
	 */
	public List<InfoBoardVO> getAllInfoBoardList();
	
	/**
	 * 검색할 회원 정보를 담은 InfoBoardVO객체를 이용하여 회원정보를 조회하는 메서드
	 * @param InfoBoardVO 검색할 회원 정보를 담은 InfoBoardVO객체
